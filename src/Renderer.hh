...
namespace Renderer {
     ...
     * @param batch  is the batch to draw with.
     * @param bounds is the bounds to fit it in. If you make this too
     *               small then it will render nothing at all.
     ...
     */
    void rect(Batch *batch, SDL_Rect bounds, SDL_Rect sprite);
     ...
     */
    void text(Batch *batch, Vec pos, char const *text, SDL_Rect font);
